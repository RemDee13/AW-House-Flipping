...
export const HOTSPOTS: Hotspot[] = [
  ...
  { id: 'windows', label: 'Windows', x: 0.52, y: 0.41, icon: AppWindow,
    ...
    cost: 11200 },
  { id: 'lawn', label: 'Lawn & Landscaping', x: 0.20, y: 0.78, icon: Trees,
    ...
    cost: 5300 },
  { id: 'plumbing', label: 'Plumbing', x: 0.595, y: 0.69, icon: Droplets,
    before: 'Corroded galvanized supply, a leaking hose bib and drains, and a failing water heater.',
    work: ['Full PEX repipe', 'New fixtures & shut-offs', 'Tankless water heater', 'Sewer scope + spot repair'],
    cost: 9700 },
  { id: 'fence', label: 'Fence', x: 0.55, y: 0.91, icon: Fence,
    ...
    cost: 4600 },
  { id: 'gate', label: 'Gate', x: 0.15, y: 0.727, icon: DoorOpen,
